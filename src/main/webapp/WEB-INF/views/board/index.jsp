...
<body>
	...
	<link rel="shortcut icon"
		href="${pageContext.request.contextPath}/resources/eshopper/images/ico/favicon.ico">
				...
				<div id="slider-carousel" class="carousel slide"
					...
					<div class="carousel-inner">
						<div class="item active">
							...
							<div class="col-sm-6">
								<img
									src="${pageContext.request.contextPath}/resources/eshopper/images/home/girl1.jpg"
									class="girl img-responsive" alt="" /> <img
									src="${pageContext.request.contextPath}/resources/eshopper/images/home/pricing.png"
									class="pricing" alt="" />
							</div>
						</div>
						<div class="item">
							...
							<div class="col-sm-6">
								<img
									src="${pageContext.request.contextPath}/resources/eshopper/images/home/girl2.jpg"
									class="girl img-responsive" alt="" /> <img
									src="${pageContext.request.contextPath}/resources/eshopper/images/home/pricing.png"
									class="pricing" alt="" />
							</div>
						...
						<div class="item">
							...
							<div class="col-sm-6">
								<img
									src="${pageContext.request.contextPath}/resources/eshopper/images/home/girl3.jpg"
									class="girl img-responsive" alt="" /> <img
									src="${pageContext.request.contextPath}/resources/eshopper/images/home/pricing.png"
									class="pricing" alt="" />
							</div>
		...
		<div class="row">
			<div class="col-sm-3">
				<div class="left-sidebar">
					...
					<div class="shipping text-center">
						<!--shipping-->
						<img
							src="${pageContext.request.contextPath}/resources/eshopper/images/home/shipping.jpg"
							alt="" />
					</div>
					<!--/shipping-->
			...
			<div class="col-sm-9 padding-right">
				<div class="features_items">
					<!--features_items-->
					<h2 class="title text-center">Board List</h2>
			...
			<%-- 		<table width="500" cellpadding="0" cellspacing="0" border="1">
						<c:forEach items="${list}" var="vo">
							<tr>
								<td>${vo.bId}</td>
								<td>${vo.bName}</td>
								<td><c:forEach begin="1" end="${vo.bIndent}">-</c:forEach>
						...
						<div class="product-image-wrapper">
							...
							<c:forEach items="${index}" var="vo">
									...
									<div class="productinfo text-center">
										<img
											src="${pageContext.request.contextPath}/resources/eshopper/images/home/product1.jpg"
											alt="" />
										<h2>${list.bId}</h2>
										<p>제목</p>
										<p>작성일</p>
										<a href="#" class="btn btn-default add-to-cart"><i
											class="fa fa-shopping-cart"></i>이름</a>
									</div>
								...
								<div class="choose">
									<ul class="nav nav-pills nav-justified">
										<li><a href="#"><i class="fa fa-plus-square"></i>조회수</a></li>
										<li><a href="#"><i class="fa fa-plus-square"></i>이름</a></li>
									</ul>
								</div>
							</c:forEach>	
						</div>
				...
				<%-- 	<div class="col-sm-4">
						...
						<div class="product-image-wrapper">
							...
							<div class="single-products">
								<div class="productinfo text-center">
									<img
										src="${pageContext.request.contextPath}/resources/eshopper/images/home/product2.jpg"
										alt="" />
									<h2>번호</h2>
									<p>제목</p>
									<p>작성일</p>
					...
					<div class="col-sm-4">
						...
						<div class="product-image-wrapper">
							...
							<div class="single-products">
								<div class="productinfo text-center">
									<img
										src="${pageContext.request.contextPath}/resources/eshopper/images/home/product3.jpg"
										alt="" />
									<h2>번호</h2>
									<p>제목</p>
									<p>작성일</p>
					...
					<div class="col-sm-4">
						<div class="product-image-wrapper">
							<div class="single-products">
								<div class="productinfo text-center">
									<img
										src="${pageContext.request.contextPath}/resources/eshopper/images/home/product4.jpg"
										alt="" />
									<h2>4</h2>
								...
								<img
									src="${pageContext.request.contextPath}/resources/eshopper/images/home/new.png"
									class="new" alt="" />
							</div>
							<div class="choose">
								<ul class="nav nav-pills nav-justified">
					...
					<div class="col-sm-4">
						<div class="product-image-wrapper">
							<div class="single-products">
								<div class="productinfo text-center">
									<img
										src="${pageContext.request.contextPath}/resources/eshopper/images/home/product6.jpg"
										alt="" />
									<h2>$56</h2>
									<p>Easy Polo Black Edition</p>
									<a href="#" class="btn btn-default add-to-cart"><i
							...
							<div class="col-sm-3">
								<div class="product-image-wrapper">
									<div class="single-products">
										<div class="productinfo text-center">
											<img
												src="${pageContext.request.contextPath}/resources/eshopper/images/home/gallery2.jpg"
												alt="" />
											<h2>$56</h2>
											<p>Easy Polo Black Edition</p>
											<a href="#" class="btn btn-default add-to-cart"><i
							...
							<div class="col-sm-3">
								<div class="product-image-wrapper">
									<div class="single-products">
										<div class="productinfo text-center">
											<img
												src="${pageContext.request.contextPath}/resources/eshopper/images/home/gallery4.jpg"
												alt="" />
											<h2>$56</h2>
											<p>Easy Polo Black Edition</p>
											<a href="#" class="btn btn-default add-to-cart"><i
							...
							<div class="col-sm-3">
								<div class="product-image-wrapper">
									<div class="single-products">
										<div class="productinfo text-center">
											<img
												src="${pageContext.request.contextPath}/resources/eshopper/images/home/gallery1.jpg"
												alt="" />
											<h2>$56</h2>
											<p>Easy Polo Black Edition</p>
											<a href="#" class="btn btn-default add-to-cart"><i
							...
							<div class="col-sm-3">
								<div class="product-image-wrapper">
									<div class="single-products">
										<div class="productinfo text-center">
											<img
												src="${pageContext.request.contextPath}/resources/eshopper/images/home/gallery3.jpg"
												alt="" />
											<h2>$56</h2>
											<p>Easy Polo Black Edition</p>
											<a href="#" class="btn btn-default add-to-cart"><i
								...
								<div class="col-sm-4">
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-center">
												<img
													src="${pageContext.request.contextPath}/resources/eshopper/images/home/recommend1.jpg"
													alt="" />
												<h2>$56</h2>
												<p>Easy Polo Black Edition</p>
												<a href="#" class="btn btn-default add-to-cart"><i
								...
								<div class="col-sm-4">
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-center">
												<img
													src="${pageContext.request.contextPath}/resources/eshopper/images/home/recommend2.jpg"
													alt="" />
												<h2>$56</h2>
												<p>Easy Polo Black Edition</p>
												<a href="#" class="btn btn-default add-to-cart"><i
								...
								<div class="col-sm-4">
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-center">
												<img
													src="${pageContext.request.contextPath}/resources/eshopper/images/home/recommend3.jpg"
													alt="" />
												<h2>$56</h2>
												<p>Easy Polo Black Edition</p>
												<a href="#" class="btn btn-default add-to-cart"><i
		...
		<div class="container">
			<div class="row">
						...
						<div class="video-gallery text-center">
							<a href="#">
								<div class="iframe-img">
									<img
										src="${pageContext.request.contextPath}/resources/eshopper/images/home/iframe1.png"
										alt="" />
								</div>
					...
					<div class="col-sm-3">
						<div class="video-gallery text-center">
							<a href="#">
								<div class="iframe-img">
									<img
										src="${pageContext.request.contextPath}/resources/eshopper/images/home/iframe2.png"
										alt="" />
								</div>
								<div class="overlay-icon">
									<i class="fa fa-play-circle-o"></i>
					...
					<div class="col-sm-3">
						<div class="video-gallery text-center">
							<a href="#">
								<div class="iframe-img">
									<img
										src="${pageContext.request.contextPath}/resources/eshopper/images/home/iframe3.png"
										alt="" />
								</div>
								<div class="overlay-icon">
									<i class="fa fa-play-circle-o"></i>
					...
					<div class="col-sm-3">
						<div class="video-gallery text-center">
							<a href="#">
								<div class="iframe-img">
									<img
										src="${pageContext.request.contextPath}/resources/eshopper/images/home/iframe4.png"
										alt="" />
								</div>
								<div class="overlay-icon">
									<i class="fa fa-play-circle-o"></i>
				...
				<div class="col-sm-3">
					<div class="address">
						<img
							src="${pageContext.request.contextPath}/resources/eshopper/images/home/map.png"
							alt="" />
